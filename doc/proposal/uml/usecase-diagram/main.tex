...
% actors
    ...
    \actor*{Administrator}{1in}{0pt};
%    \foreach \a in {User,Administrator}
    ...
    \foreach \side/\Map in {%
        ...
        % set use case port \pactor according to \side
        \ifx\side\echowest
            \def\pactor{east}
        % \ifx\side\echowest
...
%
        ...
        \foreach \actor/\Usecases in \Map {
% each actor label
            \node[below=0pt of \actor-south] {\actor};
% each association
            % \usecaseno use case number
            \foreach \usecaseno in \Usecases {
                \draw (\actor-\pactor) -- (les-fleurs-body-\usecaseno-1.\side);
            } % \foreach \usecaseno
        } % \foreach \actor/\Usercases
    } % \foreach \side/\Map
\end{tikzpicture}
